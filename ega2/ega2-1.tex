...
However, we will see in Chapter~III \sref[III]{III.4.2.4} a result in this sense, of an ``asymptotic'' nature, valid for \emph{coherent} sheaves on $X$ when $f$ is proper~(5.4) and $S$ is Noetherian.
\end{remark}
