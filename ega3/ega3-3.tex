...
\begin{proof}
\label{proof-III.3.2.1}
The question being local on $Y$, we can suppose $Y$ Noetherian, thus $X$ Noetherian~\sref[I]{I.6.3.7}.
...
\begin{proof}
\label{proof-III.3.2.4}
\oldpage[III]{118}
The question being local on $Y$, we can suppose $Y$ Noetherian, and it is the same for $X$~\sref[I]{I.6.3.7}.
...
As for the second assertion of~\sref{III.3.4.3}, it suffices, $\mathfrak{Y}$ being Noetherian, to cover it by a finite number of Noetherian affine open sets $U_i$ and to note that the restricyions of the projective system $(\RR^q f_*(\sh{F}_k))$ to each of the $U_i$ satisfies (ML).
\end{env}
