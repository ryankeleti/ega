...
In the proof of Theorem~\sref{3.2.4.1}[i], the hypothesis on $f$ was only used to show (with the notation of this proof) that $\RR^p f_*'(\wt{\sh{M}})$ is a coherent $\sh{O}_{Y'}$-module.
