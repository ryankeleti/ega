...
So suppose that $1<n<m$, and let $Z_0\subset Z_1\subset\ldots\subset Z_n$ be a saturated chain such that there exists another saturated chain, with first element $Z_0$ and last element $Z_n$, of length $m$.
