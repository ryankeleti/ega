...
neighborhood $U$ of $y=f(x)$, the functor $(f^*(\sh{G})\otimes_{\sh{O}_X}\sh{F})_x$ in $\sh{G}$
...
\emph{each} open neighborhood $U$ of $y$, the functor $(f^*(\sh{G})\otimes_{\sh{O}_X}\sh{F})_x$
