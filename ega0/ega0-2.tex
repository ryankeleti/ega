...
If $Z_1$ and $Z_2$ are two distinct irreducible components of the space $X$, then $Z_1\cap Z_2$ is a closed \emph{rare} set in each of the subspaces $Z_1$, $Z_2$; in particular, if an irreducible component of $X$ admits a generic point \sref{0.2.1.2}, such a point cannot belong to any other irreducible component.
