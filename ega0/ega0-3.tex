...
(F) \emph{For any covering $(U_\alpha)$ of an open set $U$ of $X$ by open sets
    ...
    (resp. $\rho_{\alpha\beta}$) \emph{the restriction morphism}
    \[
...
(F$_0$) \emph{For any covering $(U_\alpha)$ of $U\in\fk{B}$ by sets
...
that $\fk{H}_\lambda$ is a \emph{subsheaf} of $\sh{F}_\lambda$ for each
