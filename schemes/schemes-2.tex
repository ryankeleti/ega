...
generic point of $X$ is a result of Proposition \sref{1.2.1.4} and of \hyperref[0.2.1.3]{(\textbf{0},~2.1.3)}.
\end{proof}
...
\begin{proof}
\label{proof-1.2.4.7}
We have already seen this when $\mathfrak{a}_y=0$ \sref{1.2.4.2}, and it suffices
