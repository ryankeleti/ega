...
\hyperref[0.5.3.11]{(\textbf{0},~5.3.11)}, and \sref{1.6.1.1}.
...
If moreover the conditions of Proposition \hyperref[1.5.9.1]{(9.5.1)} are satisfied, then it follows from \sref{1.9.5.4} that $f(X)$ is dense in $Y'$; if $X$ is irreducible, then so is $Y'$ \hyperref[0.2.1.5]{(\textbf{0},~2.1.5)}.
...
We thus conclude \sref{1.1.3.13} that $\sh{F}$ is the cokernel of a $\sh{B}$-homomorphism $\sh{B}^m\to\sh{B}^n$, and is thus coherent, since $\sh{B}$ is a coherent sheaf of rings \hyperref[0.5.3.4]{(\textbf{0},~5.3.4)}.
