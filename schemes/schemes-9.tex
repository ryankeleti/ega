...
\begin{proof}
\label{proof-1.9.6.6}
In fact, it follows from \sref{1.9.4.9} that $\sh{B}$ is the inductive limit (as an $\OO_X$-module) of its quasi-coherent sub-$\OO_X$-modules of finite type; the latter generating quasi-coherent sub-$\OO_X$-\emph{algebras} of $\sh{B}$ of finite type \sref{1.1.3.14}, and so $\sh{B}$ is a fortiori their inductive limit.
\end{proof}
