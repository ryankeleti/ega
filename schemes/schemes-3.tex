...
\hyperref[1.3.2.2]{(3.2.2)}, there similarly exists $X\times_S Y$ by Lemma \hyperref[lem-1.3.2.6.3]{(3.2.6.3)}. If $S$
...
\begin{proof}
\label{proof-1.3.2.7}
This follows from Corollary \hyperref[1.3.2.5]{(3.2.5)} and Lemma \hyperref[lem-1.3.2.6.1]{(3.2.6.1)}.
\end{proof}
