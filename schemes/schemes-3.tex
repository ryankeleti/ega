...
\begin{proof}
\label{proof-1.3.6.1}
Since $\Spec(\OO_y/\fk{a}_y)\to Y$ is \unsure{radical} (\sref{1.3.5.4} and \sref{1.2.4.7}), $\Spec(\OO_y/\fk{a}_y)$ is \unsure{reduced at a single point}, and the ideal $\fk{m}_y/\fk{a}_y$ is nilpotent by hypothesis \sref{1.1.1.12}, we already know (\sref{1.3.5.10} and \sref{1.3.3.4}) that $p$ identifies, as {\em sets}, the underlying space of $X\times_Y\Spec(\OO_y/\fk{a}_y)$ with $f^{-1}(y)$; everything boils down to proving that $p$ is a homeomorphism.
