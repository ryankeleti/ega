...
\oldpage[I]{123}
    ...
    As the support of $\psi_*(\OO_Y)$ is $Z=\psi(Y)$, $\theta$ is a {\em surjective} homomorphism from $\OO_X=\widetilde{A}$ to the quasi-coherent $\OO_X$-module $f_*(\OO_Y)$.
