...
\hyperref[1.1.4.1]{(1.4.1)}; $Y$ is then equal to the closed subset $V(\mathfrak{I})$ of
...
$Y$ is closed in $U$ \hyperref[1.4.1.3]{(4.1.3)}; $Y$ is then defined by a quasi-coherent sheaf of
...
\oldpage[I]{122}
of preschemes $Z\to Y$ \hyperref[1.2.2.1]{(2.2.1)}, which according to the above is such that
