...
\begin{proof}
\label{proof-1.4.4.5}
The statement is evidently local on $X$ and $Y$; it thus suffices to note that if $B$ is an $A$-algebra and $\fk{K}$ an ideal of $B$. then we have $A\otimes_B(B/\fk{K})=A/\fk{K}A$, and to apply \sref{1.1.6.9}.
\end{proof}
