...
Since the prime ideals of $A_x$ correspond bijectively to the prime ideals of $A$ that are contained in $\mathfrak{j}_x$ \hyperref[0.1.2.6]{(\textbf{0},~2.1.6)}, the minimal prime ideals of $A_x$ correspond to the minimal prime ideals of $A$ that are contained in $\mathfrak{j}_x$, whence the lemma.
\end{proof}
