...
by a canonical bijective correspondence, there is a corresponding sequence $(\wt{a}_n)$ of sheaves of ideals in $\wt{A}=\OO_X$;
...
\begin{enumerate}[label=\emph{(\roman*)}]
    ...
    \item Suppose further that $S$ is locally Noetherian.
        For every local $\OO_s$-homomorphism $\vphi\colon\OO_y\to\OO_x$, there exists an open neighbourhood $U$ of $x$ in $X$, and an $S$-morphism $f=(\psi,\theta)$ from $U$ to $Y$ such that $\psi(x)=y$ and $\theta_x^\sharp=\vphi$.
\end{enumerate}
\end{prop}
...
\begin{enumerate}[label=\emph{(\roman*)}]
    \item For $f$ to be a local immersion at the point $x$ \sref{1.4.5.1}, it is necessary and sufficient that $\theta_x^\sharp\colon\OO_y\to\OO_x$ be surjective.
...
\begin{enumerate}[label=\emph{(\roman*)}]
    \item For $f$ to be a local immersion at any point of $X$, it is necessary and sufficient that $\theta_x^\sharp\colon\OO_y\to\OO_x$ be surjective.
