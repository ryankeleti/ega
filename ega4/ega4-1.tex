...
\label{4.1.1.1}
We say that a morphism of preschemes $f:X\to Y$ is \emph{quasi-compact} if the continous map $f$ from the topological space $X$ to the topological space $Y$ is quasi-compact~\sref[0]{0.9.1.1}, in other words, if the inverse image $f^{-1}(U)$ of every quasi-compact open subset $U$ of $Y$ is quasi-compact~(cf.~\sref[I]{I.6.6.1}).
\end{definition}
