...
To see that they are sufficient, it is enough to show, because of \sref{IV.16.9.3}, that if, in a point $x \in \Supp(\sh{O}_X/\sh{I})$, there is a neighborhood $U$ of $x$ in $X$ and $n$-sections $f_i$ $(1 \leq i \leq n)$ of $\sh{I}$ over $U$ such that the image in $\sh{I}/\sh{I}^2$ form a basis of $(\sh{I}/\sh{I}^2)|U$ over $(\sh{O}_X/\sh{I})|U$, then there is a neighborhood $V \subset U$ of $x$ such that the $f_i|V$ generate $\sh{I}|V$.
