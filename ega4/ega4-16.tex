...
\label{IV.16.4.15}
The notations being that of \sref{IV.16.4.14}, let $R$ be a multiplicative subset of $A$ such that $\rho(R) \subset S$.
...
\begin{enumerate}
  ...
  In chapter V, we will also give a variant, in the case of modules over a prescheme, the ``imperfection modules'' studied in \sref[0]{0.20.6}, and the exact sequences where they occur.
