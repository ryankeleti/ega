...
def get_parts(path):
  ...
  lijst.append('xxx')
  parts = {}
  chapters = open(path + "chapters.md", 'r')
  n = 0
  name = lijst[n]
...
list_of_labeled_envs = ['lem', 'prop', 'thm', 'rmk', 'exm', 'exercise', 'nota', 'defn']
list_of_standard_labels = ['defn', 'lem', 'prop', 'thm', 'rmk', 'exm', 'section', 'subsection', 'subsubsection', 'item']
