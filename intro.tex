...
developed by M.~Nagata in a series of memoirs \cite{9}, which contain many
...
algebraic geometry, we pick out the work of E.~K\"ahler \cite{22} and a recent
note of Chow and Igusa \cite{3}, which go back over certain results of (FAC) in
