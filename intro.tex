...
{its actual publication clearly ought to have been later.}\marginpar{?} For the use of
...
dealing with the fundamentals, is of course influenced, ?\marginpar{?}, by
...
\begin{itemize}
  ...
  \item[4\textsuperscript{th}]
                 ...
                 ``{multiform} sections''\marginpar{?} of suitable schemes over $X$
                 ...
                 completion of $A$, from a known result of ?\marginpar{?} to an
