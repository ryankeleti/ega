...
\oldpage{5}
This memoir, and the many others that must follow, are intended to form a
...
being one), deterred by the dryness of the classic {\it Foundations} of A.~Weil
\cite{I-18}. It is there that it is shown, for the first time, that the ``Zariski
...
J.-P.~Serre has recently been broached by H.~Grauert \cite{I-5}, and there is room
...
idea and our theory, see Chapter~I, \textsection8. One such extension has been
...
\begin{itemize}
  ...
  \item[3rd]
    ...
    (Chapter~III, \textsection\textsection3, 4, and 5) lets us pass from the
...
\input{schemes/schemes-1}
\input{schemes/schemes-2}
\input{schemes/schemes-3}
\input{schemes/schemes-4}
\input{schemes/schemes-5}
\input{schemes/schemes-6}
\input{schemes/schemes-7}
\input{schemes/schemes-8}
\input{schemes/schemes-9}
\input{schemes/schemes-10}
