...
In addition, the tensor product commutes with inductive limits of sheaves, and we thus habe
...
generated by its sections over $X$, then $\sh{F}$ is generated by its sections over $X$.
\end{envs}
