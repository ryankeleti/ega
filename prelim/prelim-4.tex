...
ring \sref{0.1.1.1}; we say that $\sh{A}$ is {\em reduced} if it is reduced
...
\begin{env}[4.4.1]
\label{0.4.4.1}
The hypotheses and notations being the same as in \sref{0.4.2.1}, let
...
is a $\Psi''$-morphism which we call the {\em composition} of $u$ and $v$.
\end{env}
