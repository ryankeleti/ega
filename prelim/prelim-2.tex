...
an irreducible component of $X$ admits a generic point \sref{0.2.1.2}, such a
...
$z$, and if $f(Z)$ is dense in $Y$, we must have $f(z)=y$ \sref{0.2.1.5}; in
...
$z$ is necessarily contained in $Z$ \sref{0.2.1.6}, $z$ is a generic point of
