...
\begin{env}[6.3.1]
\label{0.6.3.1}
If $A$ is a ring, $S$ a multiplicative subset of $A$, $S^{-1}A$ is a {\em flat $A$-module}.
...
then $M$ is {\em $A$-flat}. Indeed, it suffices \sref{0.6.3.3} to prove that
...
\[
  ...
  \tag{6.7.6.1}
\]
is an {\em isomorphism} when $\sh{F}$ admits a {\em finite presentation} \sref{0.5.2.5}.
...
\sref{0.6.6.2}. When $f$ is faithfully flat, $f^*$ is an {\em exact} and {\em faithful}
