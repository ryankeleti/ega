...
{\em loc. cit.}, th.~2; the fact that \sref{0.7.1.10} implies
\sref{0.7.1.14} follows from {\em loc. cit.},
...
\begin{lem}[7.3.2.1]
\label{0.7.3.2.1}
{\em (Artin--Rees Lemma)}. Under the hypotheses of \sref{0.7.3.2}, there
...
\begin{enumerate}[label={\rm(\alph*)}]
  ...
  \item $\widehat{A}$ is a faithfully flat $A$-module \sref{0.6.4.1}.
...
\sref{0.1.7.2}) to the case where $M/\fk{m}M$ is {\em simple}, thus
...
$1\leqslant i\leqslant r$ \sref{0.7.5.3}; if we prove that $u$ is {\em surjective},
...
follows from Corollary \sref{0.7.3.6}.
\end{proof}
