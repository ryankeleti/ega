...
\begin{env}[8.1.6]
\label{0.8.1.6}
We apply Proposition \hyperref[0.8.1.4]{(8.1.4)} to the case where $F$ is $h_{X'}$, $X'$ being any
object of $\C$; the map $\beta:\Hom(X,X')\to\Hom(h_X,h_{X'})$ is none other than the map
$w\mapsto h_w$ defined in \hyperref[0.8.1.2]{(8.1.2)}; this map being {\em bijective}, we see
with the terminology of \hyperref[0.8.1.5]{(8.1.5)} that:
\end{env}
...
Proposition \hyperref[0.8.1.7]{(8.1.7)} that the data of an $X\in\C$ and an isomorphism of functors
$g:h_X\to F$ determines $X$ up to unique isomorphism. Proposition \hyperref[0.8.1.7]{(8.1.7)} then
...
Proposition \hyperref[0.8.1.4]{(8.1.4)} that the data of a natural transformation $g:h_X\to F$ is
...
$h_{X'}\to F'$ two isomorphisms of functors. Then it follows from \hyperref[0.8.1.6]{(8.1.6)} that
