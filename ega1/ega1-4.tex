...
then ${j'}^{-1}(X'')$ and ${j''}^{-1}(X')$ are both equal to the greatest lower bound $\inf(X',X'')$ of $X'$ and $X''$ for the ordering $\leqslant$ on subpreschemes, and this is canonically isomorphic to $X'\times_X X''$.
\end{cor}
