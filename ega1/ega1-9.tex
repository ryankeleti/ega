...
\label{I.9.3.2}
With the hypotheses of \sref{I.9.3.1}, consider the graded ring $A_*=\Gamma_\bullet(\sh{L})$
and the graded $A_*$-module $M_*=\Gamma_\bullet(\sh{L},\sh{F})$ \sref[0]{0.5.4.6}. If $f\in A_n$,
