...
so there exists some $f\in A$ such that $D(f)$ is an open neighbourhood of $x$ contained inside $V\cap W$ \sref{I.1.1.10}[i].
...
Furthermore, for each pair of indices $(\alpha,\beta)$, each point of $V_\alpha\cap V_\beta$ admits an affine open neighbourhood $W$ contained inside $V_\alpha\cap V_\beta$ \sref{I.2.1.3};
