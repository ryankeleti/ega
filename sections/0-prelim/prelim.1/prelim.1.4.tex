...
$i_M^T=\rho_M^{T,S}\circ i_M^S$; in canonical identification \emph{1.2.5}, $\rho_M^{T,S}$ identifies with
...
\eref{1.4.4}, we can uniquely define a homomorphism $\varphi:A'\to S^{-1}A$ such that the diagram
\[\begin{tikzcd}
