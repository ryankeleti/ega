...
\begin{cx}[Proposition]{2.2.5}
    ...
    Then there exists a canonical bijective \oldpage{100}correspondence between $f$-morphisms $\sheaf{F}\to\sheaf{G}$ (\textbf{0},~4.4.1) and $A$-homomorphisms $M\to(\Gamma(X,\sheaf{G}))_{[\varphi]}$.
\end{cx}
