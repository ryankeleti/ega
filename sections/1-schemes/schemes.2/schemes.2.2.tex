...
$\theta''^\#=\theta^\#\circ\psi^\ast(\theta'^\#)$ (\textbf{0},~3.5.5). From this
...
injection (\textbf{0},~4.1.2) of the induced prescheme $(U,\O_X|U)$ into
...
follows rapidly from (\textbf{0},~4.1.1).
\end{env}
...
Under the hypotheses of \eref{2.2.4}, let
...
\eref{2.2.4}, we are rapidly led to the case where $X$ is affine, and the proposition
