...
$y\in\overline{\{z\}}$ (\emph{or, equivalenty, the \emph{???}\marginpar{?} of $y$
...
point of this space}\marginpar{?}, and since $\psi(a)=y$, the image of $\Spec(\O_y)$ under
...
true when $A$ is {\emph{factorial}}\marginpar{?}.
\end{envr}
