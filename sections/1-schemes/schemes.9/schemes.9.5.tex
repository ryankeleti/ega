...
Under the conditions of \eref{9.5.1}, let
...
$Y'$ of $Y$ defined by $\sheaf{J}$ satisfies the conditions of \eref{9.5.1}.
\end{env}
...
\begin{env}[Definition]{9.5.3} Whenever there exists a smaller subprescheme $Y'$
...
If $f_\ast(\O_X)$ is a quasicoherent
$\O_Y$-module, then the underlying space of the closed image of $X$ by $f$ is
the closure $\overline{f(X)}$ in $Y$.
\end{env}
