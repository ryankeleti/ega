...
\begin{enumerate}[label=\normalfont(\roman*)]
    ...
    \item Again\oldpage{173}, $X$ is a finite union of affine opens $U_i$ ($1\leqslant i\leqslant r$) such that $\sheaf{L}|U_i\cong\O_X|U_i$, and for every $i$, $(s\otimes f^{\otimes n})|(U_i\cap X_f)$ is identified (by the aforementioned isomorphism) with $(f|(U_i\cap X_f))^n(s|(U_i\cap X_f))$.
