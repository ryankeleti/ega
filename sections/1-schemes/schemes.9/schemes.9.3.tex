...
{\normalfont(\textbf{0},~5.4.1)}, $f$ a section of $\sheaf{L}$ over $X$, $X_f$ the open
set of $x\in X$ such that $f(x)\neq0$ {\normalfont(\textbf{0},~5.5.1)}, and $\sheaf{F}$ a
...
With the hypotheses of \eref{9.3.1}, consider the graded ring $A_\ast=\Gamma_\ast(\sheaf{L})$
...
Suppose that the hypotheses of \eref{9.3.1} are satisfied, and suppose further that
...
With the hypotheses of \eref{9.3.4}, there exists a closed subprescheme $Y$ of $X$, whose
...
$\sheaf{J}_x^n\subset\sheaf{J}_x$ for all $x\in X$. We can, thanks to \eref{9.3.4}, thus
