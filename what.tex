...
Due to EGA being a collection of volumes (one non-preliminary chapter per volume, with the later volumes being split across multiple chapters), the page numbers reset at every new chapter.
