...
Along the margins we have provided the page numbers corresponding to the original text, as published by \emph{Publications math\'ematiques de l'I.H.\'E.S.}, where the EGA were published as the following volumes:\footnote{PDFs of which can be found online, hosted by the \emph{Grothendieck circle}.}
\begin{enumerate}
...
As EGA~IV was written, the \textsection\textsection11--21 would contain different sections than initially envisaged.
